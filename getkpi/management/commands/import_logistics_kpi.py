...
LOGISTICS_KPI_DEFINITIONS: list[dict] = [
    ...
    {
        "kpi_id": "LOG-M3",
        "name": "Бюджет и ФОТ блока в пределах лимита",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Удерживать бюджет и ФОТ службы логистики в утвержденных лимитах",
        "formula": "Факт затрат и ФОТ / Утвержденный лимит × 100%",
        "unit": "%",
        "source": "1С ERP / БДР / ФОТ / паспорта KPI",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    {
        "kpi_id": "LOG-Q1",
        "name": "Доля лояльных / квалифицированных поставщиков",
        "block": "плитка",
        "frequency": "ежеквартально",
        "perspective": "Поставщики",
        "goal": "Повышать долю надежных поставщиков в базе службы логистики",
        "formula": "Лояльные или квалифицированные поставщики / Все активные поставщики × 100%",
        "unit": "%",
        "source": "1С ERP / база поставщиков / паспорта KPI",
        "monthly_target": None,
        "quarterly_target": "≥80%",
        "yearly_target": "≥80%",
        "green_threshold": "≥80%",
