...
LOGISTICS_KPI_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "frequency": "ежедневно",
        "perspective": "Финансы",
        "goal": "Контролировать долю просроченной дебиторской задолженности по НПО и АЛМАЗ",
        "formula": "Просроченная ДЗ / Общая ДЗ × 100%",
        "unit": "руб.",
        "source": "MSSQL erp_pm: ведомость расчётов с поставщиками (РасчетыСПоставщикамиПоСрокам), без связок НПО↔Алмаз",
        "monthly_target": "<5%",
        "quarterly_target": None,
        "yearly_target": "<5%",
        "green_threshold": "<5%",
    ...
    },
    {
        ...
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Контролировать отгрузки так же, как коммерческий директор (KD-M2)",
        "formula": "Факт отгрузок / План МП по отгрузкам × 100%",
        "unit": "руб.",
        "source": "MSSQL erp_pm: те же отгрузки, что KD-M2",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
        ...
        "position": 5,
        "description": (
            "Те же план, факт и ожидаемо, что у плитки «Отгрузки» коммерческого директора (KD-M2).\n"
            "Источник: MSSQL erp_pm, расчёт comdir.get_otgruzki_ytd."
        ),
    },
    {
        "kpi_id": "LOG-M7",
