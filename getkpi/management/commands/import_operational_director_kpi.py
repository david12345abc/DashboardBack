...
OD_KPI_DEFINITIONS: list[dict] = [
    ...
    {
        "kpi_id": "OD-M3.2",
        "name": "ФОТ компании в пределах лимита",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Привязать роль к контролю ФОТ компании",
        "formula": "Факт ФОТ компании / План ФОТ компании × 100%",
        "unit": "%",
        "source": "1С / ЗУП / HRIS",
        "monthly_target": "≤100%",
        "quarterly_target": None,
    ...
    },
    {
        ...
        "formula": "Инициативы/проекты, закрытые в срок / План квартала × 100%",
        "unit": "%",
    ...
    },
    {
        ...
        "formula": "Количество уволенных за период / Среднесписочная численность × 100%",
        "unit": "%",
