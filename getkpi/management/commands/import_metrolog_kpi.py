...
FULL_DASHBOARD: list[dict] = [
    {
        ...
        "unit": "%",
        "source": "MSSQL erp_pm: _InfoRg43704 / _Document1052 (Метрологическая служба)",
        "monthly_target": "≥100%",
    ...
    },
    {
        ...
        "frequency": "Ежемесячно",
        "perspective": "Финансы",
        "goal": "Выполнить план производства в части метрологической службы",
        "formula": "Факт выполнения плана производства в части МС / План производства в части МС × 100%",
        "unit": "%",
        "source": "MSSQL erp_pm: _InfoRg43704 / _Document1052 (Метрологическая служба)",
        "monthly_target": "≥100%",
    ...
    },
    {
        ...
        "frequency": "Ежемесячно",
        "perspective": "Процессы",
        "goal": "Соблюдать сроки поверки и ремонта",
        "formula": "Работы, выполненные в срок / Все работы × 100%",
        "unit": "%",
        "source": "1С",
        "monthly_target": "≥95%",
    ...
    {
        "kpi_id": "METD-M3",
        "name": "Бюджет и ФОТ метрологической службы в пределах лимита",
        "block": "плитка",
        "frequency": "Ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать бюджет и ФОТ метрологической службы в пределах лимита",
        "formula": "Факт бюджета и ФОТ / План бюджета и ФОТ × 100%",
        "unit": "%",
        "source": "1С",
        "monthly_target": "≤100%",
        "quarterly_target": None,
    ...
    {
        "kpi_id": "METD-Q1",
        "name": "Проекты метрологической службы без существенных отклонений",
        "block": "плитка",
        "frequency": "Ежеквартально",
        "perspective": "Развитие",
        "goal": "Контролировать проекты метрологической службы без существенных отклонений",
        "formula": "Проекты без существенных отклонений / Все активные проекты метрологической службы × 100%",
        "unit": "%",
        "source": "Turbo Project",
        "monthly_target": None,
        "quarterly_target": "≥90%",
    ...
    },
    {
        ...
        "frequency": "Ежеквартально",
        "perspective": "Персонал",
        "goal": "Сохранить квалифицированный персонал метрологической службы",
        "formula": "Уволенные / Среднесписочная численность × 100%",
        "unit": "%",
        "source": "HR",
        "monthly_target": None,
    ...
    {
        "kpi_id": "METD-Q3",
        "name": "Доля проектов отдела сертификации без отклонений > 10 дней",
        "block": "плитка",
        "frequency": "Ежемесячно",
        "perspective": "Развитие",
        "goal": "Контролировать проекты отдела сертификации без существенных отклонений по вехам",
        "formula": "Проекты отдела сертификации без отклонения >10 р.д. / Все активные проекты отдела сертификации × 100%",
        "unit": "%",
        "source": "Turbo Project",
        "monthly_target": "≥90%",
        "quarterly_target": "≥90%",
