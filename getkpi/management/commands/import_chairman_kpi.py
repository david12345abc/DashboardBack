...
FULL_DASHBOARD: list[dict] = [
    ...
    },
    {
        ...
        "formula": "ДЗ / КЗ × 100% — отдельно для клиентов (РасчетыСКлиентамиПоСрокам) и поставщиков (РасчетыСПоставщикамиПоДокументам: ПредоплатаРегл / ДолгРегл)",
        "unit": "%",
        "source": "1С: РасчетыСКлиентамиПоСрокам, РасчетыСПоставщикамиПоДокументам (регл. валюта)",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "unit": "%",
        "source": "1С Document_ТД_ПроизводственныйПлан / Текущий месяц (План/Факт Месяц)",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
