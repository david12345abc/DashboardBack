...
PD_KPI_DEFINITIONS: list[dict] = [
    {
        "kpi_id": "PD-M1.1.M",
        "name": "Выполнение производственного плана: месяц (Турбулентность)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы Турбулентности за последний месяц",
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска Турбулентности; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.1.W",
        "name": "Выполнение производственного плана: неделя (Турбулентность)",
        "block": "плитка",
        "frequency": "еженедельно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы Турбулентности за последнюю неделю",
        "formula": "Фактический выпуск / Недельный план выпуска × 100%",
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска Турбулентности пропорционально дням недели; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.1.T",
        "name": "Выполнение производственного плана: итого (Турбулентность)",
        "block": "плитка",
        "frequency": "с начала года",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы Турбулентности накопительно с начала года",
    ...
    },
    {
        ...
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска Алмаза; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "formula": "Фактический выпуск / Недельный план выпуска × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска Алмаза пропорционально дням недели; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "frequency": "с начала года",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы Алмаза накопительно с начала года",
        "formula": "Фактический выпуск с начала года / План выпуска с начала года × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска Алмаза; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
    ...
    {
        "kpi_id": "PD-M3.B1",
        "name": "Бюджет (Турбулентность)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать бюджет Турбулентности",
        "formula": "Факт затрат / План затрат × 100%",
        "unit": "руб.",
        "source": "БДР / 1С / управленческая отчетность (Турбулентность)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    {
        "kpi_id": "PD-M3.F1",
        "name": "ФОТ (Турбулентность)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать ФОТ Турбулентности",
        "formula": "Факт ФОТ / План ФОТ × 100%",
        "unit": "руб.",
        "source": "1С / ЗУП / HRIS (Турбулентность)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    },
    {
        ...
        "unit": "%",
        "source": "TurboProject / проекты Турбулентности и Алмаза",
        "monthly_target": "≥90%",
        "quarterly_target": "≥90%",
        "yearly_target": "≥90%",
        "green_threshold": "≥90%",
    ...
    {
        "kpi_id": "PD-Q2.1",
        "name": "Текучесть персонала (Турбулентность)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Персонал",
        "goal": "Снизить текучесть персонала в Турбулентности",
        "formula": "Факт / План × 100%",
        "unit": "чел.",
        "source": "1С / Document_ТД_ТекучестьПерсонала (подразделения Турбулентности)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
