...
PD_KPI_DEFINITIONS: list[dict] = [
    {
        ...
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска Турбулентность-Дон; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
    ...
    },
    {
        ...
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска Турбулентность-Дон пропорционально дням недели; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы Турбулентность-Дон накопительно с начала года",
