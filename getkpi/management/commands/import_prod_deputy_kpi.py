...
PD_KPI_DEFINITIONS: list[dict] = [
    {
        "kpi_id": "PD-M1.1",
        "name": "Выполнение производственного плана (ПЦ1)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ1",
    ...
    {
        "kpi_id": "PD-M1.2",
        "name": "Выполнение производственного плана (ПЦ2)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ2",
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "шт.",
