...
PD_KPI_DEFINITIONS: list[dict] = [
    {
        ...
        "unit": "руб.",
        "source": "1С Document_ТД_ПроизводственныйПлан / ПланРуб и ФактРуб",
        "monthly_target": "≥100%",
    ...
    },
    {
        ...
        "unit": "руб.",
        "source": "1С Document_ТД_ПроизводственныйПлан / последняя неделя выбранного месяца по ПериодПо",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "unit": "руб.",
        "source": "1С Document_ТД_ПроизводственныйПлан / ПланРуб и ФактРуб за выбранный месяц",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "шт.",
        "source": "1С Document_ТД_ПроизводственныйПлан / ПланШт и ФактШт",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    },
    {
        ...
        "formula": "Факт итого за выбранный месяц / План итого за выбранный месяц × 100%",
        "unit": "шт.",
        "source": "1С Document_ТД_ПроизводственныйПлан / ПланШт и ФактШт за выбранный месяц",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
