...
PD_KPI_DEFINITIONS: list[dict] = [
    {
        "kpi_id": "PD-M1.1.M",
        "name": "Выполнение производственного плана: месяц (ПЦ1)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ1 за последний месяц",
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска ПЦ1; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.1.W",
        "name": "Выполнение производственного плана: неделя (ПЦ1)",
        "block": "плитка",
        "frequency": "еженедельно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ1 за последнюю неделю",
        "formula": "Фактический выпуск / Недельный план выпуска × 100%",
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска ПЦ1 пропорционально дням недели; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.1.T",
        "name": "Выполнение производственного плана: итого (ПЦ1)",
        "block": "плитка",
        "frequency": "с начала года",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ1 накопительно с начала года",
        "formula": "Фактический выпуск с начала года / План выпуска с начала года × 100%",
        "unit": "руб.",
        "source": "ХардКодинг / план выпуска ПЦ1; 1С Document_ТД_ПроизводственныйПлан / факт руб.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
    ...
    {
        "kpi_id": "PD-M1.2.M",
        "name": "Выполнение производственного плана: месяц (ПЦ2)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ2 за последний месяц",
        "formula": "Фактический выпуск / План выпуска × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска ПЦ2; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.2.W",
        "name": "Выполнение производственного плана: неделя (ПЦ2)",
        "block": "плитка",
        "frequency": "еженедельно",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ2 за последнюю неделю",
        "formula": "Фактический выпуск / Недельный план выпуска × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска ПЦ2 пропорционально дням недели; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
        "quarterly_target": None,
        "yearly_target": "≥100%",
        "green_threshold": "≥100%",
    ...
    {
        "kpi_id": "PD-M1.2.T",
        "name": "Выполнение производственного плана: итого (ПЦ2)",
        "block": "плитка",
        "frequency": "с начала года",
        "perspective": "Процессы",
        "goal": "Обеспечить выполнение производственной программы ПЦ2 накопительно с начала года",
        "formula": "Фактический выпуск с начала года / План выпуска с начала года × 100%",
        "unit": "шт.",
        "source": "ХардКодинг / план выпуска ПЦ2; 1С Document_ТД_ПроизводственныйПлан / факт шт.",
        "monthly_target": "≥100%",
    ...
    },
    {
        ...
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать бюджет производственного цеха №1",
        "formula": "Факт затрат / План затрат × 100%",
        "unit": "руб.",
        "source": "БДР / 1С / управленческая отчетность (Производственный цех №1)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    },
    {
        ...
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать бюджет производственного цеха №2",
        "formula": "Факт затрат / План затрат × 100%",
        "unit": "руб.",
        "source": "БДР / 1С / управленческая отчетность (Производственный цех №2)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    },
    {
        ...
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать ФОТ производственного цеха №1",
        "formula": "Факт ФОТ / План ФОТ × 100%",
        "unit": "руб.",
        "source": "1С / ЗУП / HRIS (Производственный цех №1)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    },
    {
        ...
        "frequency": "ежемесячно",
        "perspective": "Финансы",
        "goal": "Контролировать ФОТ производственного цеха №2",
        "formula": "Факт ФОТ / План ФОТ × 100%",
        "unit": "руб.",
        "source": "1С / ЗУП / HRIS (Производственный цех №2)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    {
        "kpi_id": "PD-Q2.1",
        "name": "Текучесть персонала (ПЦ1)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Персонал",
        "goal": "Снизить текучесть персонала в производственном цехе №1",
        "formula": "Факт / План × 100%",
        "unit": "чел.",
        "source": "1С / Document_ТД_ТекучестьПерсонала (подразделения ПЦ1)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
    ...
    {
        "kpi_id": "PD-Q2.2",
        "name": "Текучесть персонала (ПЦ2)",
        "block": "плитка",
        "frequency": "ежемесячно",
        "perspective": "Персонал",
        "goal": "Снизить текучесть персонала в производственном цехе №2",
        "formula": "Факт / План × 100%",
        "unit": "чел.",
        "source": "1С / Document_ТД_ТекучестьПерсонала (подразделения ПЦ2)",
        "monthly_target": "≤100%",
        "quarterly_target": None,
        "yearly_target": "≤100%",
        "green_threshold": "≤100%",
