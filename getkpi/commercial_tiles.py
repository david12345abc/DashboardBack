...
DEPT_TO_KPI_KEY: dict[str, str | None] = {
    ...
    norm_dept('Отдел внешнеэкономической деятельности'): 'ОВЭД',
    norm_dept('Отдел ПМУ и ЭО'): 'ОПЭОиУ',
    norm_dept('Отдел ОПЭОиУ'): 'ОПЭОиУ',
    ...
    norm_dept('Отдел дилерских продаж промышленного оборудования'): 'ОДП',
    norm_dept('Отдел дилерских продаж'): 'ОДП',
    norm_dept('ОДП'): 'ОДП',
...
KPI_KEY_TO_DEPT_GUID: dict[str, str | None] = {
    ...
    'Коммерческая служба': '95dfd1c6-37a4-11ee-93d3-6cb31113810e',
