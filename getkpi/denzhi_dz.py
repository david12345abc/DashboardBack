"""
KD-M2 «Деньги и просроченная ДЗ».

План: 1 157 000 000 ₽/мес (одинаков для каждого месяца).
Факт: жёстко задан — март 2026 = 333 853 886 ₽ (остальные месяцы пока без данных).
KPI = факт / план × 100.
Цвет: < 90 % → зелёный, иначе красный.
"""
