...
def get_td_m5_ytd(year: int | None = None, month: int | None = None) -> dict | None:
    """TD-M5: делегат в techdir_m5 (план TurboProject, факт ext_budj_fact)."""
    from .techdir_m5 import get_td_m5_ytd as _get_td_m5_ytd

    return _get_td_m5_ytd(year=year, month=month)
