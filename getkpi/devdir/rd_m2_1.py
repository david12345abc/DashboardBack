"""KPI RD-M2-1: план из rd_m2_1_plan, факт ФОТ «Служба развития»."""
...
from .rd_m2_1_plan import RD_M2_1_PLAN_BY_MONTH
...
def _build_rd_m2_1_monthly_payload(year: int | None = None, month: int | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "debug": {
            "target_plan_source": "getkpi/devdir/rd_m2_1_plan.py",
